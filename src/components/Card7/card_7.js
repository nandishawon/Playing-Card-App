...
import Image from '../images/card_image_7.png';
import AnimatedPage from "../AnimatedPage";


const Card7Component = () => {
    ...
    return (
        <div className="page-body">
            ...
            <span className="back" onClick={() => { navigate("/card_6") }}>
                {yellow ?
                    ...
                    <div className={`card-box ${isFlipped ? 'flip' : 'front'} ${isHoverEnabled ? 'enable-hover' : ''}`}
                        ...
                        {!reveal ?
                            <div className="card-body" onClick={() => { setReveal(false) }}>
                                <p>Dad bought 10 oranges, and mom bought 6. How many oranges are there in total?</p>
                            ...
                            <div className="image-card-body" onClick={() => { setReveal(true) }}>
                                ...
                                <div className="image-body-footer">
                                    <span>There are 16 oranges in total (10 + 6 = 16)</span>
                                </div>
                            </div>
                        }
                    </div>
            ...
            <span className="next" onClick={() => { navigate("/card_8") }}>
